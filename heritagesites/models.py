...
class HeritageSite(models.Model):
    ...
    longitude = models.DecimalField(max_digits=11, decimal_places=8, blank=Tre, null=True)
    latitude = models.DecimalField(max_digits=10, decimal_places=8, blank=True, null=True)
    area_hectares = models.FloatField(blank=True, null=True)
    heritage_site_category = models.ForeignKey('HeritageSiteCategory', models.DO_NOTHING)
    transboundary = models.IntegerField()
...
class Planet(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'UNSD M49 Global'
...
class Location(models.Model):
    ### no trailing ids except for location 
    ...
    class Meta:
        ...
        verbose_name = 'UNSD M49 Location Heirarchy'
        verbose_name_plural = 'UNSD M49 Location Heirarchies'
...
#can also use this string method 
    # def __str__(self):
